...
} = require("../api/controller/userController/returnOrder.controller");
// Admin Api Token
...
router.post(
  "/admin/deleteBusinessCategory",
  adminBusiness.deleteBusinessCategory
);
router.get(
  "/admin/editBusinessCategory/:id",
  adminBusiness.editBusinessCategory
);
router.post(
  "/admin/updateBusinessCategory/:id",
  adminBusiness.updateBusinessCategory
);
...
router.get(
  "/admin/getAllAdminReturnRequest",
  adminOrder.getAllAdminReturnRequest
);
...
router.delete("/admin/deleteBanner/:imageSrc", bannerAdmin.delete);
...
router.post(
  "/vendor/fetchSpecification",
  VendorSpecification.fetchSpecification
);
...
router.get(
  "/vendor/dashboard/recent-order/:vendorId",
  vendorOrder.getRecentOrderList
);
router.post(
  "/order/:orderId/change-order-status",
  vendorOrder.changeOrderStatus
);
...
router.post(
  "/user/fetchProductSpecification",
  userFetchProduct.fetchProductSpecification
);
//
...
router.post(
  "/user/fetchBusinesscategoryHeader",
  userBusiness.fetchBusinesscategoryHeader
);
...
router.post(
  "/user/myOrders/:orderId/cancel/:subOrderId",
  userOrder.orderCancelledByUser
);
router.post(
  "/user/myOrders/:orderId/cancel-request/:subOrderId",
  userOrder.orderCancelRequestByUser
);

const {
  getTransaction,
} = require("../api/controller/userController/transaction.controller");

router.post("/user/transaction", getTransaction);
router.get("/user/brands", adminBrand.fetchBrands);

const { fetchChat, addMessage } = require("../api/controller/chat.controller");
